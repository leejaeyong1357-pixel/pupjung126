...
/* ---------- 예시 보기 ---------- */
const SAMPLE=[
  ["관리직","82210465","미래성장팀","M5","박동중","직무전문","한국생산성본부","생성형 AI 업무자동화","2027-03-11","2027-03-12",2,"서울",16,480000],
  ["관리직","82211489","미래성장팀","M2","이재용","리더십","한국능률협회","프로젝트 리더십","2027-05-20","2027-05-21",2,"부산",16,550000],
  ["생산직","82210588","PT생산1팀","조장","조효근","직무자격","동우열처리","분석기 사용법 및 가스 보정 실습","2027-03-16","2027-03-16",1,"본공장",4,0],
];
  ...
  <div class="modal-b">
    ...
    <div class="tw"><table><thead><tr><th class="ctr">순번</th><th class="ctr">구분</th><th>사번</th><th>부서</th>
      ...
      ${SAMPLE.map((s,i)=>`<tr><td class="ctr num">${i+1}</td>
        ...
        <td><span class="chip ${s[5]==="리더십"?"c-ok":"c-blue"}">${s[5]}</span></td>
    ...
    <div style="margin-top:20px">
      ${[["교육구분","직무전문 · 리더십 · 직무자격 · 어학 · 기타 중에서 고릅니다."],
         ["교육기관 · 교육과정","기관명과 과정명을 안내문에 적힌 그대로 입력합니다."],
         ["교육일정","시작일과 종료일을 고르면 교육일수가 자동으로 계산됩니다. 하루짜리 교육은 두 날짜를 같게 두면 1일이 됩니다."],
