...
const SEED_OWNERS={
  ...
  // 아래 3명은 이미 교육을 이수해 미이수자 명단에 없어 이메일을 확인하지 못했습니다.
  // 엔진생산3팀·엔진품질관리2팀 담당 이한솔은 명단의 동명이인(기술사원)과 다른 사람이라 비워둡니다.
  '엔진생산실':     {name:'이새롬', email:''},
  '엔진생산1팀':    {name:'이새롬', email:''},
  '엔진생산관리팀':  {name:'이새롬', email:''},
  '엔진품질관리1팀': {name:'이새롬', email:''},
  '엔진생산2팀':    {name:'황나영', email:''},
  '엔진생산3팀':    {name:'이한솔', email:''},
  '엔진품질관리2팀': {name:'이한솔', email:''},
};
const ORG_NAMES = () => {
